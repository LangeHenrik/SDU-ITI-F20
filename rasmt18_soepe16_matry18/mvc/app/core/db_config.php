...
class DB_Config {
	...
	//protected $servername = 'localhost'; 			//Søren
	//protected $username = 'rodsur'; 				// Søren
	protected $password = 'password'; 				//Søren, Rasmus
	protected $dbname = 'rasmt18_soepe16_matry18'; 	//Alle
