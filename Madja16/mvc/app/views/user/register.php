                ...
                <div class="container">
                    <form class="form-horizontal" role="form" action="" method="POST" onsubmit="return checkform()" name="registerForm" id="registerForm" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="username" id="username" placeholder="Username" class="form-control" autofocus onchange="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span id="validConfirmPassword"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-9">
...
<?php include '../app/views/partials/registerFooter.php'; ?>