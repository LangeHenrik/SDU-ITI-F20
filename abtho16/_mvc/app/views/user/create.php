...
<script type="text/javascript" src="abtho16/mvc/app/services/validation.js"></script>
...
<form action="save" class="register" onsubmit="return validateUser(username.value, password.value, repeatPassword.value,
