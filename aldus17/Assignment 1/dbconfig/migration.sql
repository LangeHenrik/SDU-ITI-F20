...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user` AS SELECT
  Host,
  User,
...
CREATE DATABASE IF NOT EXISTS `users` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_danish_ci */;
USE `users`;

-- Dumping structure for tabel users.users
CREATE TABLE IF NOT EXISTS `users` (
  `userID` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(100) COLLATE utf8_danish_ci NOT NULL DEFAULT '0',
  `fullname` varchar(100) COLLATE utf8_danish_ci NOT NULL DEFAULT '0',
  `email` varchar(100) COLLATE utf8_danish_ci NOT NULL DEFAULT '0',
  `phone` int(11) NOT NULL DEFAULT 0,
  `password` varchar(150) COLLATE utf8_danish_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`userID`)
