...
VALUES
	...
	('rebecsen', 'Rebecca Henningsen', 'rebecsen@gmail.com', '$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'),
	('eriksten', 'Erik Steffensen', 'eriksten@gmail.com', '$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'),
	('johald', 'Johan Pilgaard', 'johald@gmail.com', '$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'),
	('gustaven', 'Gustav Klausen', 'gustaven@gmail.com', '$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'),
	('bjarkech', 'Bjarke Ellegaard-Hald Bech', 'bjarkech@gmail.com', '$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'),
	('johanth', 'Johanna Smith', 'johanth@gmail.com', '$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2');
...
VALUES
	((SELECT userID FROM users WHERE users.username='willien'),'images/-045rdpAsZA.jpg', 'A window', 'Closed window with white sunscreen'),
	...
	((SELECT userID FROM users WHERE users.username='eriksten'), 'images/cwwBXiMibTY.jpg', 'Motorcycle', 'Ride in the dessert'),
