...
class HomeController extends Controller {
    ...
    public function signup() {
	    if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            header("Location: /rayou18_kalau17_jlaur13/mvc/public/Home/index");
	...
	public function logout() {
		...
		//if($this->post()) {
			session_unset();
			header('Location: /rayou18_kalau17_jlaur13/mvc/public/home/loggedout');
		//} else {
	...
	public function loggedout() {
        ...
        header('Location: /rayou18_kalau17_jlaur13/mvc/public/home');
	}
