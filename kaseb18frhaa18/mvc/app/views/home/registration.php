...
<div class="wrapper">
  <div class="content">
    <form action="Register/registration" method="post">
      ...
      <input placeholder="Username" type="text" name="username" id="username" required onkeyup="return checkUserName()" />
      <span id="username_err"></span>
      <input placeholder="Password" type="password" name="password" id="password" required onkeyup="return checkPassword()" />
